...
const BUDGET_OPTIONS = [
  {
    ...
    max: 300,
    icon: 'fa-piggy-bank',
    label: { en: 'Under USD 300', de: 'Unter 300 USD' },
  },
  {
    value: 'b2',
    min: 300,
    max: 700,
    icon: 'fa-wallet',
    label: { en: 'USD 300 – 700', de: '300 – 700 USD' },
  },
  {
    value: 'b3',
    min: 700,
    max: 1500,
    icon: 'fa-credit-card',
    label: { en: 'USD 700 – 1,500', de: '700 – 1.500 USD' },
  },
  {
    value: 'b4',
    min: 1500,
    max: 5000,
    icon: 'fa-sack-dollar',
    label: { en: 'USD 1,500 – 5,000', de: '1.500 – 5.000 USD' },
  },
  {
    value: 'b5',
    min: 5000,
    max: Infinity,
    icon: 'fa-gem',
    label: { en: 'Over USD 5,000', de: 'Über 5.000 USD' },
  },
  {
    value: 'any',
    min: 0,
